...
def test_page_rank(max_iter, prop_name=None):
    """
...
def main():
    ...
    # adding logic because hardcoded index  is not correct for name 59
    pagerank_result = {entry['name']: entry['score'] for entry in result}
    
    if 159 in pagerank_result and 59 in pagerank_result and \
        round(pagerank_result[159], 5) == 3.22825 and round(pagerank_result[59], 5) == 0.18247:
    ...
    # testing for unreachable nodes
    print("*"*50) 
    print("Testinng BFS for unreachable nodes:")   
    
    result1 = test_bfs(184, 59)
    print(result1)

    # testing for page rank without weight parameter
    print("*"*50) 
    print("Testinng page rank without weight parameter:")
    result2 = test_page_rank(20)
    print(result2)
